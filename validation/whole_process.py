...
class WholeProcess:
    ...
    def __init__(self, input_folder: str, output_folder: str, random_segmentation_path: dict, patch_shape=(8, 8)):
        ...
        self.patch_creators = [PatchCreator(brain, real, patch_shape, labelized_img=labelized_images) for brain, real in zip(self.brain_slices, self.realignements, labelized_images)]
...
if __name__ == '__main__':
    ...
    for i, files_dict in enumerate(random_seg_per_instance):
        ...
        try:
            ...
            pass
        current_wp = WholeProcess(input_folder='/Users/arnaud.marcoux/histo_mri/images',
                                  output_folder=current_out_fold,
                                  random_segmentation_path=files_dict,
                                  patch_shape=(8, 8))
        save_object(current_wp, join(current_out_fold, 'pickeled_wp'))